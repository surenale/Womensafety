...
public class ShakeDetector {
    ...
    public com.alethesuren.womensafety.ShakeDetector start(Context context, ShakeCallback shakeCallback) {
    ...
    public com.alethesuren.womensafety.ShakeDetector startService(Context context) {
        this.sensorManager = (SensorManager) context.getSystemService(Context.SENSOR_SERVICE);
        List<Sensor> sensors = this.sensorManager.getSensorList(Sensor.TYPE_ACCELEROMETER);
        if (sensors.size() > 0) {
            sensor = sensors.get(0);
